<?php
/**
 * Plugin Name: Gravity Forms: Multiple Form Instances (Think It First)
 * Description: Allows multiple instances of the same form to be run on a single page when using AJAX. (Reserving original ID)
 * Author: Jonathan Sample
 * Author URI: http://thinkitfirst.com/
 * Plugin URI: https://github.com/thinkitfirst/Gravity-Forms-Multiple-Form-Instances
 * Version: 1.1.1
 * License: GPL2
...
class Gravity_Forms_Multiple_Form_Instances { 
     ...
     */ 
    public function gform_get_form_filter_multiple( $form_string, $form ) { 
